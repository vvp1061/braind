...
/**
 * Далее удаляем ворнинги, добавляя фатальные ошибки. Т.к в результате работы первого цикла while
 * ворнингов было столько, сколько нужно для дальшейшего удаления фатальных ошибок, ничего дополнительно проверять не приходится
 */
